...
import { getApprenticeDetailsControllerFactory } from '../factories/controller/apprentice/get-apprentice-details/get-apprentice-details-controller-factory'
...
export default (router: Router) => {
  ...
  router.get('/apprentice', apprenticeMiddleware, expressRouteAdapter(getApprenticeDetailsControllerFactory()))
